...
const jasstone = require('../../modules/game/jasstone.js'); // module 호출
const jas = jasstone();

module.exports = function(io) {
    let chat = io.of('/jasstone').on('connection', function(socket) {
        ...
        socket.on('setting', function(data) {
            ...
            chat.emit('setting', res);
            // setInterval(function() { socket.emit('cost'); }, 1000);
        });
